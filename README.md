...
1. Create a project folder (you can call it `ng-starter-lib` and rename it later).
1. [Clone](#clone "Clone it from github") or [download](#download "download it from github") the **ng-starter Library seed** into your project folder.
...
```
git clone https://github.com/anjanikumar2109/ng-starter-lib.git
cd ng-starter-lib
npm install
npm start
```
...
## What's in the ng-starter Library seed?

The **ng-starter Library seed** contains a similar structure to the [Quickstart seed](https://github.com/angular/quickstart).
...
- Copy typings, metadata, html and css.
...
Use your editor to search the project for all instances of `ng-starter-lib` and change it
